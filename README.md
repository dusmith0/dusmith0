...
* **Current Focus:** Forthcoming Consulting and Capstone Projects
...
* **R Package Creation** Authored the package `APStatTools` designed to bridge the gap between classroom theory and automated statistical computation.
